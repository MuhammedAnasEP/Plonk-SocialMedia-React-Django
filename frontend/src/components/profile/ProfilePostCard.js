...
import { comments, getcomments, getlike, getpost, like, getuser, editpost, deletepost, deletecomment, unlike, backend } from "../../Constants/Constants";
                ...
                <Card className="">
                    ...
                    <div>
                        <div className="h-[400px] max-w-[500px] flex items-center justify-center overflow-hidden rounded-md">
                            {newPost ? <img className="rounded-md" src={URL.createObjectURL(newPost)} /> : <img className="rounded-md" src={backend+editImage}/>}
                        </div>
